...
const photoswipe = {
    ...
    init(el) {
        ...
        const parseThumbnailElements = () => {
            const thumbElements = document.getElementsByClassName('js-thumb');
            ...
            for (let i = 0; i < numNodes; i += 1) {
                ...
                if (linkEl.children.length > 0) {
                    ...
                    item.msrc = linkEl.children[0].children[1].getAttribute(
                        'src',
                    );
                }
        ...
        const onThumbnailsClick = e => {
            ...
            // eslint-disable-next-line prefer-destructuring
            const childNodes = document.getElementsByClassName('js-thumb');
